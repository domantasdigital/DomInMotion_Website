...
const LetsCreateLink = ({ onClick }: { onClick?: () => void }) => (
  ...
  >
    ...
    <svg className={styles.spark} viewBox="0 0 40 40" fill="none" aria-hidden="true">
      <path d="m20 3 4 10 10-5-5 10 8 4-11 3 4 11-10-7-8 8 1-12-10-3 11-5-4-10 10 6Z" fill="currentColor" stroke="#311847" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  </SectionLink>
);
...
export default function NavBar() {
  ...
  const closeNavigation = () => {
    // Unlock before the browser starts the anchor scroll on mobile.
      ...
      >
        <div className="mx-auto grid h-16 w-full grid-cols-[auto_1fr_auto] items-center gap-3 px-6 sm:h-[4.5rem] sm:px-10 lg:h-20 lg:grid-cols-[1fr_auto_1fr] lg:px-11">
          ...
          <div className="justify-self-end lg:hidden">
            <LetsCreateLink onClick={closeNavigation} />
          </div>
